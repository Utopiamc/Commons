package de.utopiamc.subscribable;
...
public class Variables {
    ...
    public <T> SubscribableVariable<T> createSubscribableVariable(T instance) {
        return new SubscribableVariableImpl<>(instance);
    }

    private static final class SubscribableVariableImpl<T> implements SubscribableVariable<T> {

        private T instance;
        private final Set<Consumer<T>> subscribers;

        public SubscribableVariableImpl(T instance) {
    ...
    public <K, T> SharedSubscribableVariable<K, T> createSharedSubscribableVariable(Function<K, T> startInstance) {
        return new SharedSubscribableVariableImpl<>(startInstance);
    }

    private static final class SharedSubscribableVariableImpl<K, T> implements SharedSubscribableVariable<K, T> {
        ...
        public SharedSubscribableVariableImpl(Function<K, T> startInstanceResolver) {
